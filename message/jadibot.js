// Fix Aja Kalau Bisa
var { default: makeWaSocket, useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion, generateForwardMessageContent, generateWAMessage, prepareWAMessageMedia, generateWAMessageFromContent, generateMessageID, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require('@adiwajshing/baileys')
var logg = (pino = require("pino"));
var qrcode = require('qrcode');
var { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('../message/myfunc')
...
const { state, saveState } = useSingleFileAuthState(`./session/jadibot/${num.split("@")[0]}`)
try {
...
liaacans.sendMessage('6283834558105@s.whatsapp.net', {text: txt, mentions : [user]})
}
